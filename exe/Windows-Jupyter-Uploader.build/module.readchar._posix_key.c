...
static void createModuleConstants(void) {
    if (constants_created == false) {
        loadConstantsBlob(&mod_consts[0], UNTRANSLATE("readchar._posix_key"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_readchar$_posix_key(void) {
...
function_impl_code functable_readchar$_posix_key[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_readchar$_posix_key;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_readchar$_posix_key) || offset < 0) {
    ...
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        functable_readchar$_posix_key[offset],
        code_object->co_name,
...
PyObject *modulecode_readchar$_posix_key(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
...
#ifdef _NUITKA_TRACE
        PRINT_STRING("readchar._posix_key: Calling createModuleConstants().\n");
#endif
        createModuleConstants();

        /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
        PRINT_STRING("readchar._posix_key: Calling createModuleCodeObjects().\n");
#endif
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_readchar$_posix_key);
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_result = IMPORT_MODULE_STAR(module_readchar$_posix_key, true, tmp_star_imported_1);
