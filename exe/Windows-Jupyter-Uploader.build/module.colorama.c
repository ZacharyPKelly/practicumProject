...
static PyCodeObject *codeobj_b979bfd055d9a7466b331407dc605064;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[1]; CHECK_OBJECT(module_filename_obj);
    codeobj_b979bfd055d9a7466b331407dc605064 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[29], mod_consts[29], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_b979bfd055d9a7466b331407dc605064;
    ...
    frame_b979bfd055d9a7466b331407dc605064 = MAKE_MODULE_FRAME(codeobj_b979bfd055d9a7466b331407dc605064, module_colorama);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_b979bfd055d9a7466b331407dc605064);
    assert(Py_REFCNT(frame_b979bfd055d9a7466b331407dc605064) == 2);
    ...
    }
    {
        ...
        frame_b979bfd055d9a7466b331407dc605064->m_frame.f_lineno = 2;
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        frame_b979bfd055d9a7466b331407dc605064->m_frame.f_lineno = 3;
    ...
    tmp_import_from_2__module = NULL;
    {
        ...
        frame_b979bfd055d9a7466b331407dc605064->m_frame.f_lineno = 4;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_b979bfd055d9a7466b331407dc605064, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_b979bfd055d9a7466b331407dc605064->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_b979bfd055d9a7466b331407dc605064, exception_lineno);
    }



    assertFrameObject(frame_b979bfd055d9a7466b331407dc605064);
